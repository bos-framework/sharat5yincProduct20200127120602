...
namespace BOS.StarterCode
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            SetApplicationDefaultConfiguration();
        ...
        public void SetApplicationDefaultConfiguration()
        {
            ApplicationSettings.ApiBaseUrl = Configuration["BOS:ServiceBaseURL"] + "" + Configuration["BOS:MultiTenancyRelativeURL"];
            var result = ApiClientFactory.Instance.GetApplicationConfiguration(Configuration["PublicUrl"]);
        }
    }
}
